...
class NatureQN(Linear):
    ...
    def initialize_models(self):
        ...
        self.q_network = nn.Sequential(nn.Conv2d(n_channels * self.config.state_history, 32, 8, 4),
                                            nn.ReLU(),
                                            nn.Conv2d(32, 64, 4, 2),
                                            nn.ReLU(),
                                            nn.Conv2d(64, 64, 3, 1),
        ...
        self.target_network = nn.Sequential(nn.Conv2d(n_channels * self.config.state_history, 32, 8, 4),
                                       nn.ReLU(),
                                       nn.Conv2d(32, 64, 4, 2),
                                       nn.ReLU(),
                                       nn.Conv2d(64, 64, 3, 1),
